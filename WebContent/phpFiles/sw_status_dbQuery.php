...
// Check connection
 if (mysqli_connect_errno())
 {
  ...
  $result = mysqli_query($con,"SELECT room1_lightSw_on, room1_heatSw_on, room2_lightSw_on, room2_heatSw_on, room3_lightSw_on, room3_heatSw_on, room4_lightSw_on, room4_heatSw_on FROM current_data" );
...
function setSwStatus(){
	...
	document.getElementById("tempTreshold2").value = <?php echo $room1_heating_limit?>;
	document.getElementById("tempTreshold3").value = <?php echo $room1_heating_limit?>;
	document.getElementById("tempTreshold4").value = <?php echo $room1_heating_limit?>;
