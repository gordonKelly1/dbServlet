...
// Check connection
 if (mysqli_connect_errno())
 {
  ...
  $result = mysqli_query($con,"SELECT temp2, heating_on FROM sensor3 Where tstamp >= ".$epochMinus24." order by entryID asc limit 86400" );
