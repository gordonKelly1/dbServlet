...
// Create connection
 ...
 $epochMinus24 = $epoch - (1000*3600*24);
 
 $con=mysqli_connect("localhost:3306","root","miltown1","db1");
...
// Check connection
 if (mysqli_connect_errno())
 {
  ...
  $result = mysqli_query($con,"SELECT * FROM sensor1 where tstamp > ".$epochMinus24);
  
  while($row = mysqli_fetch_array($result))
  {
  	echo $row['temp'] . " " . $row['als'];
  	echo "<br>";
  }
